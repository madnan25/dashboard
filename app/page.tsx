...
export default async function HomePage() {
  ...
  const marketingInbox = isMarketingTeam && profile ? await repo.getMarketingHomeInbox(6) : null;
        ...
        {isMarketingTeam && marketingInbox ? (
          <div className="space-y-4">
            <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-5 md:p-6">
              <div className="text-xs uppercase tracking-[0.25em] text-white/50">Marketing Premium</div>
